	...
	public void updateObject(String data_object_id, Ga4ghDataObject object) throws EntityNotFoundException, Exception {
		...
		if (!data_object_id.equals(object.getId())) {
			...
			objects_DataObjectId.forEach(o -> {
				...
				o.getUrls().forEach(u -> urls.add(new Ga4ghURL(u.getUrl(), new HashMap<>(u.getSystem_metadata()), new HashMap<>(u.getUser_metadata()))));
				ga4ghDataObjectRepository.save(new Ga4ghDataObject(false, object.getId(), o.getName(), o.getSize(), o.getCreated(),
						o.getUpdated(), o.getVersion(), o.getMimeType(), new ArrayList<>(o.getChecksums()),
						urls, o.getDescription(), new ArrayList<>(o.getAliases())));
			});
